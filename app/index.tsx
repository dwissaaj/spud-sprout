  ...
  return (
    <SafeAreaView className="h-full bg-black">
      <ScrollView contentContainerStyle={{ height: '100%' }}>
        <View className="bg-black w-full h-full justify-center items-center  px-4">
          ...
          <BaseButton handlePress={() => {}} isLoading={false} containerStyles="w-full mt-7 bg-primary " textStyle="text-white" title="Let's Plan Together" />
        </View>
      </ScrollView>
